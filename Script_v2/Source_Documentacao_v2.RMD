---
title: "Prevendo Demandas de Estoque com Base em Vendas (v2)"
...
## Declarar as variáveis numéricas do dataset
```{r}
...
### Filtrando o dataset para realizar a análise
```{r}
...
### Gráfico de cada variável sumarizado por semana
```{r}
